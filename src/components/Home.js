      ...
      {categories[0] && categories[0].tag && (
        <section className="blog-card__container py-sm-5 bg-light-shade">
          <div className="container">
                ...
                if (blog.tags.indexOf(categories[0].tag) != -1) {
                  return (
                    ...
                    >
                      ...
                      {blog.tags.map((tag, index) => {
                        return (
                          <a
                            key={index}
                            href={`/search/${tag}`}
                            className="card-tag d-inline-block"
                          >
                            {tag}
                          </a>
                        )
                      ...
                      <h3 className="heading-3 mt-3">{blog.title}</h3>
            ...
            <a
              href={`/search/${categories[0].tag}`}
              className="btn d-flex align-items-center gap-3 mt-5"
            >
