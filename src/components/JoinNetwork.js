  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row align-items-start guidance-card">
            ...
            <div className="col-11 col-md-6">
              ...
              <p>
                ...
                providing smart and friendly advice, our legal plan attorneys
                have an average customer rating of 4.8 out of 5 stars.
              </p>
              <p>
                We&apos;re always looking for talented attorneys who share our
                passion for great customer service. If you&apos;re searching for new
                ways to help others and expand your practice, we&apos;d love to hear
                from you.
              </p>
            </div>
          ...
          <div className="row align-items-start guidance-card">
            ...
            <div className="col-11 col-md-6">
              ...
              <p>
                Customers schedule consultations with tech-enabled Legal Plan
                attorneys licensed in their state.
              </p>
              <h5 className="h5">Local Attorney Directory (LAD)</h5>
              <p>
                Connect with potential clients by getting referrals from Legal
                Plan attorneys when customers need local help. New services
              </p>
              <h5 className="h5">New services</h5>
              <p>
                Be the first to know and be part of new programs we&apos;re creating
                to help customers access the legal help they need.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="network-form">
        <div className="container">
          <h1 className="h1 my-5 text-center form-title">
          ...
          <form className="row g-3">
            ...
            <div className="col-12 text-center">
              <button
                type="submit"
                className="btn form-submit-btn text-white text-uppercase text-center"
              >
                SEND MESSAGE
              </button>
            </div>
